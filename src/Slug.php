	...
	public function generator($str): string 
	{
		if(!empty($str)){
			...
			if($this->SlugsOptions['limit'] > -1){
				...
				$str = mb_substr($str, 0, ($this->SlugsOptions['limit'] ? $this->SlugsOptions['limit'] : mb_strlen($str, 'UTF-8')), 'UTF-8');
			}
			...
			if($this->SlugsOptions['unique']) {
				$str = $this->uniqueSlug($str);
			}
